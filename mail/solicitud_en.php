                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: justify;'>
                              <h2 style="font-size: 20px; text-align: center;">Payment request</h2>
                              <br>
                              <p><strong>Dear <?php echo $model->cliente->nombres ?>:</strong></p>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr><td height='24'><p><?php echo $model->empresa->razon_social ?> has sent you a request for payment for the value of <strong>$<?php echo $model->a_pagar ?> USD</strong></p>
                      </td></tr>
                    </table></td>
    </tr>
  </tbody>
                      ...
                      <td>
                        <div class='contentEditableContainer contentTextEditable'>
                          <div class='contentEditable' style='text-align: center;'>
                            ...
                            <br><br>
                            <a target='_blank' href="<?php echo Url::to(['payments/t?token='.$model->token], true) ?>" class='link2' style="color:#FFFFFF;" >Pay now</a>
                            <br>
                          </div>
                        </div>
                      </td>
