            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Nuevo Formulario",
                    'content'=>'<span class="text-success">Create Formularios success</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal",'id'=>'refreshForm']).
